...
public class HistorialCitas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnMedicos2 = new javax.swing.JButton();
        ...
        getContentPane().add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 420, -1, -1));
        ...
        btnMedicos2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnMedicos2.setText("Medicamentos");
        btnMedicos2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMedicos2ActionPerformed(evt);
            }
        });
        getContentPane().add(btnMedicos2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, 170, 30));

        btnMedicos1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnMedicos1.setText("Citas");
        getContentPane().add(btnMedicos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 510, 170, 30));
        ...
        getContentPane().add(btnLimpiarFields, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 420, -1, -1));
...
txtCurpF.setText("");
    ...
    if (filaSeleccionada >= 0) {
        // Obtener la CURP y fecha de la cita seleccionada como identificadores únicos
        String curp = tablaHistorialC.getValueAt(filaSeleccionada, 7).toString(); // Columna CURP
        String fecha = tablaHistorialC.getValueAt(filaSeleccionada, 1).toString(); // Columna Fecha
        String hora = tablaHistorialC.getValueAt(filaSeleccionada, 0).toString(); // Columna Hora

        // Confirmar con el usuario si realmente desea eliminar la cita
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try (Connection conn = ConexionDB.conectar()) {
                // Llamar al controlador para realizar la eliminación
                HistorialCitasController controlador = new HistorialCitasController();
                ...
                if (exito) {
                    ...
                    JOptionPane.showMessageDialog(this, "No se pudo eliminar la cita. Verifique los datos.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception ex) {
        ...
        JOptionPane.showMessageDialog(this, "Por favor, seleccione una cita para eliminar.", "Advertencia", JOptionPane.WARNING_MESSAGE);
    }
    ...
    private void btnMedicos2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMedicos2ActionPerformed
        // TODO add your handling code here:
        Medicamentos medicam = new Medicamentos();
        medicam.setVisible(true);
        dispose();
    }//GEN-LAST:event_btnMedicos2ActionPerformed

    private void btnPacientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPacientesActionPerformed
        // TODO add your handling code here:
        Pacientes pci = new Pacientes();
        pci.setVisible(true);
        dispose();
    ...
    private javax.swing.JButton btnMedicos2;
