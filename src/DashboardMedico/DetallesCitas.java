...
public class DetallesCitas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDetallesCitas2 = new javax.swing.JButton();
        ...
        btnDetallesCitas2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnDetallesCitas2.setText("Detalles de citas");
        getContentPane().add(btnDetallesCitas2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 530, 170, 30));

        jPanel2.setBackground(new java.awt.Color(109, 152, 255));
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 240, 80, 200));

        jPanel1.setBackground(new java.awt.Color(154, 218, 245));
        ...
        getContentPane().add(btnPacientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 470, 170, 30));
        ...
        jLabel5.setText("DETALLES DE CITAS");
    ...
    // Limpiar solamente los campos de texto
    txtCurpF.setText("");
    txtNombreF.setText("");
    ...
    // Opcional: Limpiar el JDateChooser si es necesario
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetallesCitas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton btnDetallesCitas2;
